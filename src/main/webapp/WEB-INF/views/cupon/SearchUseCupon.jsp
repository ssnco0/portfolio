...
<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<a class="navbar-brand" href="${contextPath}/">LMM</a>
						...
						<div class="nav">
							...
							<div class="collapse" id="User" aria-labelledby="headingOne"
								...
								<nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="${contextPath}/member/listMembers.do">일반
										사용자</a> <a class="nav-link" href="${contextPath}/member/StorelistMembers.do">가맹점</a>
								</nav>
							</div>
							<a class="nav-link collapsed" href="#" data-toggle="collapse"
							...
							<div class="collapse" id="Mileage" aria-labelledby="headingOne"
								data-parent="#sidenavAccordion">
								<nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="${contextPath}/mileage/Mileage.do">사용자 마일리지</a> <a
										class="nav-link" href="${contextPath}/mileage/StoreMileage.do">가맹점 마일리지</a>
								</nav>
							</div>
							<a class="nav-link collapsed" href="#" data-toggle="collapse"
							...
							<div class="collapse" id="Cupon" aria-labelledby="headingOne"
								data-parent="#sidenavAccordion">
								<nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="${contextPath}/cupon/SearchUseCupon.do">사용자 쿠폰 관리</a> <a
										class="nav-link" href="${contextPath}/cupon/SelectNoAppCupon.do">가맹점 쿠폰
										승인</a>
								</nav>
							</div>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h1 class="mt-4">사용자 쿠폰 관리</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="${contextPath}/">Dashboard</a></li>
						<li class="breadcrumb-item active">사용자 쿠폰 관리</li>
					</ol>

					<div class="card mb-4">
						<div class="card-header">
							<form id="UserType" method="post"
								action="${contextPath}/cupon/SearchUseCupon.do">
								<select class="custom-select" name="select">
									<option selected value="0">비사용</option>
