		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h1 class="mt-4">가맹점 마일리지 관리</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="${contextPath}/admin">Dashboard</a></li>
						<li class="breadcrumb-item active">가맹점 마일리지 관리</li>
					</ol>

					<div class="card mb-4">
						<div class="card-header">
							<form id="Form"
								action="${contextPath}/admin/mileage/StoMileageById.do" method="post" accept-charset="utf-8">
								<select class="custom-select" name="select">
									<option selected value="0">가맹점아이디</option>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										<c:forEach var="Storemileage" items="${StoremileageList}">
											<tr align="center">
												<td>${Storemileage.stoid}</td>
												<td>${Storemileage.stoname}</td>
												<td>${Storemileage.stoadress}</td>
												<td>${Storemileage.stolocnum}</td>
												<td>${Storemileage.cusid}</td>
												<td>${Storemileage.cusname}</td>
												<td>${Storemileage.payusemil}</td>
												<td>${Storemileage.paydate}</td>
