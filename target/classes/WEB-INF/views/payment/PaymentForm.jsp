...
<body>
	<form method="post"   action="${contextPath}/payment/addPayment.do">
	<h1  class="text_center">결제 페이지</h1>
	<table  align="center">
	   <tr>
	      <td width="200"><p align="right">결제번호</td>
	      <td width="400"><input type="text" name="" disabled ></td>
	   </tr>
	   <tr>
	    ...
	    <tr>
	       <td width="200"><p align="right">결제일</td>
	       <td width="400"><p><input type="text" name="" disabled></td>
	    </tr>
	    <tr>
	      ...
	      <tr>
	       ...
	       <td width="400"><p><input type="text" name="cupId"></td>
	    </tr>
	    <tr>
	       <td width="200"><p>&nbsp;</p></td>
